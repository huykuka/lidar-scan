...
@Component({
  ...
  template: `
    ...
    >
      ...
      >
        <app-workspace-view-controls-button [label]="showHud() ? 'Hide HUD' : 'Show HUD'"
        ...
        <!-- Camera View Presets -->
        <app-workspace-view-controls-button label="Top View"
          icon="vertical_align_top"
          (clicked)="onTopView.emit()"
         />

        <app-workspace-view-controls-button label="Front View"
          icon="view_agenda"
          (clicked)="onFrontView.emit()"
         />

        <app-workspace-view-controls-button label="Side View"
          icon="view_sidebar"
          (clicked)="onSideView.emit()"
         />

        <app-workspace-view-controls-button label="Isometric"
          icon="view_in_ar"
          (clicked)="onIsometricView.emit()"
         />

        <app-workspace-view-controls-button label="Fit to Points"
          icon="fit_screen"
        ...
        <app-workspace-view-controls-button label="Reset View"
          icon="center_focus_strong"
          (clicked)="onResetCamera.emit()"
         />

        <app-workspace-view-controls-button label="Screenshot"
          icon="photo_camera"
          (clicked)="onScreenshot.emit()"
         />

        <app-workspace-view-controls-button label="Clear Points"
          icon="delete_sweep"
          [danger]="true"
