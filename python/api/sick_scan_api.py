"""This file declares the functions and datatypes of the sick_scan_xd app-API.
...
class SickScanPointFieldArray(ctypes.Structure):
    """ 
    sick_scan_api: struct SickScanPointFieldArray, Array of SickScanPointFieldMsg, which can be serialized and imported in C, C++ or app
...
class SickScanPointArray(ctypes.Structure):
    """ 
    sick_scan_api: struct SickScanPointArray, Array of SickScanVector3Msg, which can be serialized and imported in C, C++ or app
...
class SickScanColorRGBAArray(ctypes.Structure):
    """ 
    Array of SickScanColorRGBA, which can be serialized and imported in C, C++ or app
...
def ctypesCharArrayToString(char_array):
    """ 
    Returns a app string from a zero terminated ctypes char array
    """ 
