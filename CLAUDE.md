...
This project is indexed by GitNexus as **lidar-scan** (9005 symbols, 18839 relationships, 169 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
