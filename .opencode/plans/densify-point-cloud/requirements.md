...
- [x] Secondary mode: **Target Layer Count** (simulates N-layer LIDAR)
  - Example: 16-layer LIDAR with 2x multiplier = 32-layer simulation
  - Example: 16-layer LIDAR with target=64 = 4x densification
- [x] Configuration accepts `density_multiplier` (float, default: 2.0)
- [x] Configuration optionally accepts `target_layer_count` (int, overrides multiplier if provided)
...
- [x] `target_layer_count` (int, optional): Override multiplier with target layer count
