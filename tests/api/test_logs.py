...
class TestLogsRestEndpoint:
    ...
    def test_logs_empty_when_file_not_exists(self):
        ...
        with patch('app.api.v1.logs.service.LOG_FILE', '/nonexistent/path/app.log'):
    ...
    def test_logs_returns_parsed_entries(self):
        ...
        with patch('app.api.v1.logs.service.LOG_FILE', '/test/app.log'):
...
class TestLogsWebSocketEndpoint:
    ...
    def test_logs_ws_can_connect(self):
        ...
        with patch('app.api.v1.logs.service.LOG_FILE', '/nonexistent/app.log'):
