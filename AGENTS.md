...
This project is indexed by GitNexus as **lidar-standalone** (3376 symbols, 8799 relationships, 229 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
