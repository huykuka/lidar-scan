...
This project is indexed by GitNexus as **lidar-standalone** (10063 symbols, 21799 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
